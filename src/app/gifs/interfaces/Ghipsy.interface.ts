// To parse this data:
//
//   import { Convert, SearchGiphyReponse } from "./file";
//
//   const SearchGiphyReponse = Convert.toSearchGiphyReponse(json);
//
// These functions will throw an error if the JSON doesn't
// match the expected interface, even if the JSON is valid.

export interface SearchGiphyReponse {
    data:       Gifs[];
...
export class Convert {
    public static toSearchGiphyReponse(json: string): SearchGiphyReponse {
        return cast(JSON.parse(json), r("SearchGiphyReponse"));
    }

    public static SearchGiphyReponseToJson(value: SearchGiphyReponse): string {
        return JSON.stringify(uncast(value, r("SearchGiphyReponse")), null, 2);
    }
}
